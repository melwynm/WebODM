...
- Switched auth guidance and implementation to Bearer tokens, which matches this WebODM fork.
- Updated the connection tester to handle WebODM's unpaginated project list response.
