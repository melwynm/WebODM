...
from .airtwin import AirTwinTaskImportStatus, AirTwinTaskManifest
...
urlpatterns = [
    ...
    re_path(r'projects/(?P<project_pk>[^/.]+)/tasks/(?P<pk>[^/.]+)/airtwin/status$', AirTwinTaskImportStatus.as_view(), name='api_airtwin_status'),
